...
const cardAnimateInSection4 = () => {
	...
	qpCardAnimationTL
			...
			.to(qpCard.position, {...devicePixelWiseValues.qpCard.section4Pre.position[2], duration: 0}, 6.4)
			.to(qpCard.scale, {...devicePixelWiseValues.qpCard.section4Pre.scale[1], duration: 0}, 6.4)
